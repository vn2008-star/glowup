              ...
              return (
                <div key={cat} className={styles.categorySection}>
                  ...
                  <div className={styles.serviceGrid}>
                    {catServices.map((s) => (
                      <ServiceCard key={s.id} s={s} getCategoryColor={getCategoryColor} openEdit={openEdit} handleDelete={handleDelete} />
                    ))}
                  </div>
                </div>
              );
...
function ServiceCard({ s, getCategoryColor, openEdit, handleDelete }: {
  s: Service;
  ...
  return (
    <div className={`${styles.serviceCard} ${!s.is_active ? styles.inactive : ""}`}>
      {s.image_url && (
