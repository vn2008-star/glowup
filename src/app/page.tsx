...
const plans = [
  {
    ...
    price: "25",
    target: "Solo stylist",
    features: ["1 staff member", "Online booking page", "Client CRM + photos", "SMS reminders", "Basic dashboard"],
  ...
  },
  {
    ...
    price: "75",
    target: "Small salon",
    features: ["5 staff members", "Everything in Starter", "Campaign automation", "Loyalty & referrals", "Social media tools", "Birthday specials"],
    cta: "Start Free Trial",
    highlighted: true,
  },
  {
    name: "Professional",
    price: "150",
    target: "Multi-staff salon",
    features: ["15 staff members", "Everything in Growth", "Masked communications", "AI content generator", "Advanced analytics", "Churn detection", "Staff performance"],
    cta: "Start Free Trial",
    highlighted: false,
  },
];
